...
public class Constants {
	...
	public static final String PROPERTIES_FILE_PATH = "/tests.properties";
	
	public static final String BINARY_SAMPLE_FILE_NAME = "binary-sample";
	public static final String BINARY_SAMPLE_FILE_PATH = "/" + BINARY_SAMPLE_FILE_NAME;
